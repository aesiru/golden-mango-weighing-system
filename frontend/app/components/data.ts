...
export const nodes: CustomGraphNode[] = [
  ...
  {
    id: "2",
    type: CustomGraphNodeType.Network,
    subLabel: "EC2 Instance",
    label: "i-0a1b2c3d4e5f6g7h8",
  },
  {
    id: "3",
    type: CustomGraphNodeType.Network,
    subLabel: "EC2 Instance",
    label: "i-1a1b2c3d4e5f6g7h8",
  },
  {
    id: "4",
    type: CustomGraphNodeType.Resource,
    subLabel: "File",
    label: "my-file",
  },
  {
    id: "5",
    type: CustomGraphNodeType.Secret,
    subLabel: "Secret",
    label: "tests-ansible-ssm-file-transfer",
  },
];
...
const links: CustomGraphLink[] = [
  ...
  },
  {
    ...
    showFlow: true,
    linkFlowParticleSize: 3,
    linkFlowParticleSpeed: 30,
  },
  {
    source: "1",
    target: "5",
    showFlow: true,
    linkFlowParticleSize: 2.5,
    linkFlowParticleSpeed: 20,
  },
];
